...
## Temperatur Analysis
######
event_loop_limit = 50 ## Number of loop per event
...
extreme_lower_thershold = 0.7
extreme_upper_thershold = 1.3
  
abs_deviation_thershold = 40 # temperature differnce frome previous reading
                ...
                # if(play_started):
                    ...
                    # if(loop_status < 9):
                        ...
                        # elif(loop_status == 2):
                            ...
                            # tempo_fast()
                        # elif(loop_status == 3):
                            # write_serial("Slow   Go  ,4") 
                            # tempo_slow()
                        # elif(loop_status == 4):
                            # write_serial("Fast  Move ,4") 
                            # tempo_fast()
                        # elif(loop_status == 5):
                            # write_serial("Makit     ,3") 
                            # loop_on = scratch(3,1,loop_on,1)
                        # elif(loop_status == 6):
                            # write_serial("Woww       ,3")
