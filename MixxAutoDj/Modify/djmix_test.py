...
lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
controlXY = open("//home/modchai/.mixxx/controlmixxx.txt", "w")
controlXY.write("/home/modchai/Music/Thai funk/00.Kratae (2.55).mp3\n1\n")
controlXY.close()

os.close(lockFile)
os.unlink("/home/modchai/.mixxx/controlmixxx.txt.lock")
...
while (controlCheck == False):
    checkerboard = open("/home/modchai/.mixxx/confirmixxx.txt", "r")
...
while (True):
    checkerboard = open("/home/modchai/.mixxx/mixxxposition1.txt", "r")
    canIPlayWithMadness = checkerboard.readline()
    checkerboard.close()
    ...
    if (positionNow >= 0.5806451612903226):
        lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
        controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
        controlXY.write("L2/home/modchai/.mixxx/AUTOMUSIK/11 Believe.flac.mp3\n" + str(indexWrite) + "\n")
        controlXY.close()
    ...
    while (True):
        checkerboard = open("/home/modchai/.mixxx/mixxxposition2.txt", "r")
        canIPlayWithMadness = checkerboard.readline()
        checkerboard.close()
        ...
        if (positionNow >= 0.3346613545816733):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L1/home/modchai/.mixxx/AUTOMUSIK/02 Supergrass.flac.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.8253687315634219):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L2/home/modchai/.mixxx/AUTOMUSIK/05 Midnight.flac.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.66507936507936506):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L1/home/modchai/.mixxx/AUTOMUSIK/09 Sambassim (DJ Marky VIP mix).flac.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.70982142857142858):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L2/home/modchai/.mixxx/AUTOMUSIK/18 When I'm Close 2 U.flac.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.6198630136986302):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L1/home/modchai/.mixxx/AUTOMUSIK/10. Drumagick - Cambraia.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.80):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L2/home/modchai/.mixxx/AUTOMUSIK/David W.S. - Talarico (Cd Edit).mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
    ...
    while (True):
        ...
        if (positionNow >= 0.745111):
            lockFile = os.open("/home/modchai/.mixxx/controlmixxx.txt.lock", os.O_CREAT|os.O_EXCL|os.O_RDWR)
            controlXY = open("/home/modchai/.mixxx/controlmixxx.txt", "w")
            controlXY.write("L1/home/modchai/.mixxx/AUTOMUSIK/07. Landslide - Drumandbossa.mp3\n" + str(indexWrite) + "\n")
            controlXY.close()
